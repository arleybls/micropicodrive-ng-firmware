...
See the [firmware manual](docs/FIRMWARE_MANUAL.md)
([PDF](docs/FIRMWARE_MANUAL.pdf)) for SD card preparation, everyday use and
the complete System Tools reference. Fitting the board inside the QL is
covered by the hardware installation manual in the
